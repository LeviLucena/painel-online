    ...
    <script>
        ...
        function redirecionarParaLogin() {
            setTimeout(function () {
                ...
                window.location.href = "SEU LOGIN.php"; // Redireciona para a página de login
...
<body onload="redirecionarParaLogin()">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1><i class="fas fa-chart-bar"></i> Painéis Interativos</h1>
            <p>Explore os painéis interativos: Escolha abaixo o dashboard desejado</p>
        </div>

        <div class="quadro-container">
            <div class="quadro">
                <a href="link5.php"><img src="imagens\indicadores" alt="Painel de Indicadores"></a>
                <!-- <h3>Título do Quadro 2</h3>
        <p>Descrição do Quadro 2.</p> -->
            </div>

            <div class="quadro">
                <a href="link4.php"><img src="imagens\indicadores.png" alt="Painel de Indicadores"></a>
                <!-- <h3>Título do Quadro 2</h3>
        <p>Descrição do Quadro 2.</p> -->
            </div>

            <div class="quadro">
                <a href="link1.php"><img src="imagens\indicadores.png" alt="Painel de Indicadores"></a>
                <!-- <h3>Título do Quadro 2</h3>
        <p>Descrição do Quadro 2.</p> -->
            </div>

            <div class="quadro">
                <a href="link8.php"><img src="imagens\indicadores.png" alt="Painel de Indicadores"></a>
                <!-- <h3>Título do Quadro 2</h3>
        <p>Descrição do Quadro 2.</p> -->
            </div>

            <div class="quadro">
                <a href="link9.php"><img src="imagens\indicadores.png" alt="Painel de Indicadores"></a>
                <!-- <h3>Título do Quadro 2</h3>
        <p>Descrição do Quadro 2.</p> -->
            </div>

            <div class="quadro">
                <a href="link3.php"><img src="imagens\indicadores.png" alt="Painel de Indicadores"></a>
                <!-- <h3>Título do Quadro 2</h3>
        <p>Descrição do Quadro 2.</p> -->
            </div>

            <div class="quadro">
                <a href="link2.php"><img src="imagens\indicadores.png" alt="Painel de Indicadores"></a>
                <!-- <h3>Título do Quadro 2</h3>
        <p>Descrição do Quadro 2.</p> -->
            </div>

            <div class="quadro">
                <a href="link6.php"><img src="imagens\indicadores.png" alt="Painel de Indicadores"></a>
                <!-- <h3>Título do Quadro 2</h3>
        <p>Descrição do Quadro 2.</p> -->
            </div>

            <div class="quadro">
                <a href="link7.php"><img src="imagens\indicadores.png" alt="Painel de Indicadores"></a>
                <!--  <h3>Título do Quadro 2</h3>
                <p>Descrição do Quadro 2.</p> -->
            </div>
