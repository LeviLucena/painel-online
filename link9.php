...
<body onload="redirecionarParaLogin()">
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <p>Relatório do Service Desk referente as Requisições de Mudanças solicitadas no sistema.</p>
        </div>

        <!-- Div para centralizar o iframe horizontalmente -->
        <!-- <div class="mx-auto" style="width: 1200px;"> -->
        <iframe title="POWER BI" width="1140" height="1500" src="SEU LINK DO BI" frameborder="0"
