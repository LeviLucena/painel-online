...
<head>
    ...
    <style>
        ...
        .navbar-brand img {
            max-width: 100px; /* Largura máxima do logo */
...
<div class="container">
    <!-- <div class="jumbotron">
        <h1>Painel de Indicadores Grupo de Equipamentos em Saúde - GES</h1>
    ...
    <!-- <div class="mx-auto" style="width: 1200px;"> -->
        <iframe title="PAINEL GES" width="1140" height="700" src="https://app.powerbi.com/view?r=eyJrIjoiZGUxZThkZjQtYWQ3My00MzE5LWI1MjItMDM0Y2U1YTIxNzRhIiwidCI6IjNhNzhiMGNkLTdjOGUtNDkyOS04M2Q1LTE5MGE2Y2MwMTM2NSJ9" frameborder="0" allowFullScreen="true"></iframe>
     <!-- </div> -->
