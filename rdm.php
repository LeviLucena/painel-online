...
<div class="container">
    <div class="jumbotron">
        ...
        <p>Relatório do Service Desk referente as Requisições de Mudanças solicitadas no sistema RDM.</p>
    </div>

    <!-- Div para centralizar o iframe horizontalmente -->
    <!-- <div class="mx-auto" style="width: 1200px;"> -->
        <iframe title="RDM" width="1140" height="1500" src="https://app.powerbi.com/view?r=eyJrIjoiOTNmZjZlZGUtYjc4My00YTA3LWFkNTktMDAxMWY5NzM4MmY4IiwidCI6IjNhNzhiMGNkLTdjOGUtNDkyOS04M2Q1LTE5MGE2Y2MwMTM2NSJ9" frameborder="0" allowFullScreen="true"></iframe>
     <!-- </div> -->
